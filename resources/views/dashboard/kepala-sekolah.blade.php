...
<div class="db-welcome">
    ...
    <p>Monitor dan setujui pengajuan cuti guru SD Negeri Kincang 01.</p>
</div>
...
<div class="stat-grid">
    ...
    <div class="stat-card">
        <div class="stat-info">
            <div class="s-label">Menunggu Persetujuan</div>
            <div class="s-value">{{ $pengajuanMenunggu }}</div>
            <div class="s-sub">pengajuan</div>
        </div>
    ...
    <div class="stat-card">
        <div class="stat-info">
            ...
            <div class="s-value">{{ $pengajuanDisetujui }}</div>
            <div class="s-sub">pengajuan</div>
        </div>
...
<div class="lower-grid">
    ...
    <div class="db-card">
        ...
        <a href="{{ route('persetujuan.index') }}" class="qa-btn qa-btn-primary">
            <span style="display:flex;align-items:center;gap:8px;">
                <i class="bi bi-clipboard-check-fill"></i> Proses Persetujuan
            </span>
        ...
        <a href="{{ route('laporan.hak-cuti') }}" class="qa-btn">
            <i class="bi bi-calendar-check-fill"></i> Data Hak Cuti Guru
        </a>
    </div>
    ...
    <div class="db-card">
        <div class="db-card-head">
            ...
            <h6 class="db-card-title">Menunggu Persetujuan</h6>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">
                            <a href="{{ route('persetujuan.index') }}" class="proses-btn">
